...
//If the postion of the mouse on the Y axis is smaller than 50, then make the scale 1 (origonal).
    if (mouseY < 50) {
      mouseY2 = 1;
    }
...
//Duplicate origional set of circles, move 90 degrees and place.
      push()
      rotate(radians(90));
      translate(0, -500);
...
//Duplicate origional set of rectangles, move 90 degrees and place.
      push();
      rotate(radians(90));
      translate(0, -550);
